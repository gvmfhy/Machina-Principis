...
if (typeof require !== 'undefined') {
  ...
  var GameMap = gameModel.GameMap;
  var Civilization = gameModel.Civilization;
  var Settlement = gameModel.Settlement;
  var Building = gameModel.Building;
  var Unit = gameModel.Unit;
  
  const aiManager = require('./AI-agent-manager.js');
  var AIAgentManager = aiManager.AIAgentManager;
  
  const observerInterface = require('./observer-interface.js');
  var ObserverInterface = observerInterface.ObserverInterface;
} else {
  // Browser environment - these should be available as global variables
  var GameMap = window.GameMap;
  var Civilization = window.Civilization;
  var Settlement = window.Settlement;
  var Building = window.Building;
  var Unit = window.Unit;
  var AIAgentManager = window.AIAgentManager;
  var ObserverInterface = window.ObserverInterface;
}
...
if (typeof window !== 'undefined') {
  ...
  console.log("GameCoordinator exported to window object");
}
